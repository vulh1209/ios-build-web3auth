...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Web3Auth")
		static FString encryptPrivateKey(FString msgString,FString keyString);

	UFUNCTION(BlueprintCallable, Category = "Web3Auth")
		static FString decryptPrivateKey(FString encryptString,FString keyString);

	UFUNCTION(BlueprintCallable, Category = "Web3Auth")
		static FString createAESKey();
